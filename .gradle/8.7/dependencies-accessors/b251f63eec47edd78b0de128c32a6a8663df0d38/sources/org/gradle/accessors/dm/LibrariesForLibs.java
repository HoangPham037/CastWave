...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final MultiLibraryAccessors laccForMultiLibraryAccessors = new MultiLibraryAccessors(owner);
     ...
     * with version reference <b>dexter</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    ...
    /**
     * Group of libraries at <b>multi</b>
     */
    public MultiLibraryAccessors getMulti() {
        return laccForMultiLibraryAccessors;
    }
    ...
    /**
     * Group of libraries at <b>rxbinding</b>
     */
    public RxbindingLibraryAccessors getRxbinding() {
    ...
    public static class AndroidxMedia3LibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>datasource</b> with <b>androidx.media3:media3-datasource</b> coordinates and
         * with version reference <b>media3Datasource</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getDatasource() {
            return create("androidx.media3.datasource");
        }
    ...
    public static class MultiLibraryAccessors extends SubDependencyFactory {
        private final MultiSlidingLibraryAccessors laccForMultiSlidingLibraryAccessors = new MultiSlidingLibraryAccessors(owner);

        public MultiLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>multi.sliding</b>
         */
        public MultiSlidingLibraryAccessors getSliding() {
            return laccForMultiSlidingLibraryAccessors;
        }

    }

    public static class MultiSlidingLibraryAccessors extends SubDependencyFactory {
        private final MultiSlidingUpLibraryAccessors laccForMultiSlidingUpLibraryAccessors = new MultiSlidingUpLibraryAccessors(owner);

        public MultiSlidingLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>multi.sliding.up</b>
         */
        public MultiSlidingUpLibraryAccessors getUp() {
            return laccForMultiSlidingUpLibraryAccessors;
        }

    }

    public static class MultiSlidingUpLibraryAccessors extends SubDependencyFactory {

        public MultiSlidingUpLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>panel</b> with <b>com.github.realgearinc:multi-sliding-up-panel</b> coordinates and
         * with version reference <b>multiSlidingUpPanel</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getPanel() {
            return create("multi.sliding.up.panel");
        }
    ...
    public static class RxbindingLibraryAccessors extends SubDependencyFactory {
        private final RxbindingAppcompatLibraryAccessors laccForRxbindingAppcompatLibraryAccessors = new RxbindingAppcompatLibraryAccessors(owner);

        public RxbindingLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>rxbinding.appcompat</b>
         */
        public RxbindingAppcompatLibraryAccessors getAppcompat() {
            return laccForRxbindingAppcompatLibraryAccessors;
        }

    }

    public static class RxbindingAppcompatLibraryAccessors extends SubDependencyFactory {

        public RxbindingAppcompatLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>v7</b> with <b>com.jakewharton.rxbinding2:rxbinding-appcompat-v7</b> coordinates and
         * with version reference <b>rxbindingAppcompatV7</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV7() {
            return create("rxbinding.appcompat.v7");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>dexter</b> with value <b>6.2.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getDexter() { return getVersion("dexter"); }
        ...
        /**
         * Version alias <b>exoplayer</b> with value <b>2.17.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>kotlinxCoroutinesAndroid</b> with value <b>1.9.0-RC</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>kotlinxCoroutinesCore</b> with value <b>1.9.0-RC</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>lifecycleLivedataKtx</b> with value <b>2.8.4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>media</b> with value <b>1.7.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>media3Datasource</b> with value <b>1.4.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getMedia3Datasource() { return getVersion("media3Datasource"); }
        ...
        /**
         * Version alias <b>multiSlidingUpPanel</b> with value <b>1.3.6</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getMultiSlidingUpPanel() { return getVersion("multiSlidingUpPanel"); }
        ...
        /**
         * Version alias <b>playServicesCastFramework</b> with value <b>21.5.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>rxbindingAppcompatV7</b> with value <b>2.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getRxbindingAppcompatV7() { return getVersion("rxbindingAppcompatV7"); }
